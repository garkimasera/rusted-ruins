...
impl Game {
    pub fn new() -> Game {
        ...
        chara::add_chara(&mut game, chara, Some(::common::array2d::Vec2d::new(0,0)), chara::CharaType::Player);
        let mut chara = create_chara(::common::objholder::CharaTemplateIdx(1), 10);
        chara.params.spd = 100;
        chara.rel = ::common::chara::Relationship::HOSTILE;
        add_chara(&mut game, chara, Some(::common::array2d::Vec2d::new(2,2)), chara::CharaType::OnMap);
        game
    }
